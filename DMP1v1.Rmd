...
usgs_onlytoprown <- dplyr::select(usgs,1:4)
head(usgs_onlytoprown, 3)
```

This dataset has `r nrow(usgs)` samples.
...
discovered, they will be integrated into the proposed compendium. 
    - Data
...
readily-accessible and it is compatible with [ESRI](www.esri.com) a Geographic
...
as documentation for the data and to cite the data.[See, for evidence, @Clement_2013]
...
text files documenting the provenance. 
    a. The database will be preserved in
perpetuity, 
    a. housed initially at the New Mexico Interstate Stream
Commission Central Office in addition to an off-site copy maintained at
an NMISC field office and 
    a. mirrored at the Consortium of Universities for
...
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Knitting with R</span> by <a xmlns:cc="http://creativecommons.org/ns#" href="https://github.com/sanjinmuftic/markdown-pandoc-sanjin" property="cc:attributionName" rel="cc:attributionURL">Sanjin Muftic</a> is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>.<br />Based on a work at <a xmlns:dct="http://purl.org/dc/terms/" href="https://github.com/AuthorCarpentry/markdown-pandoc-student.git" rel="dct:source">https://github.com/AuthorCarpentry/markdown-pandoc-student.git</a>.<br />Permissions beyond the scope of this license may be available at <a xmlns:cc="http://creativecommons.org/ns#" href="http://sanjinmuftic.com" rel="cc:morePermissions">sanjinmuftic.com</a>.
